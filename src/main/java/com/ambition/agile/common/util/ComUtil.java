...
public class ComUtil {
	...
	public static Float integerToFloat(Integer num) {
		if(isNotNullOrEmpty(num)){
			return num.floatValue() / Constants.precisionNum;
		}else{
			return (float)0;
		}
	...
	public static Integer floatToInteger(Float num) {
		if(isNotNullOrEmpty(num)){
			num = num * Constants.precisionNum;
			return num.intValue();
		}else{
			return (int)0;
		}
	...
	public static void main(String[] args) {
		...
		/*
		String s = "/document/grade/schoolework/新干教8月份剩余功能开发计划_1377936558249.xls";
		s = getNewStr(s);
		...
		*/
		...
		System.out.println(isNum(s.substring(0,1)));
	}
