...
public class MailUtil {
	 ...
	 * 获取单例进程
	 */
	public static  synchronized MailUtil getMailInstance() {  
	 ...
	 */
	private MimeMessage createMimeMessage(MailBean mailBean) throws MessagingException, IOException {
	 ...
	 * @return
	 */
	private String getMessage(MailBean mailBean) throws IOException {
		StringWriter writer = null;
		try {

			writer = new StringWriter();
			VelocityContext context = new VelocityContext(mailBean.getData());
			System.out.println(mailBean.getTemplate());
