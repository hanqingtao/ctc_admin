...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/users/userComment/">评价信息列表</a></li>
		<li class="active"><a href="${ctx}/users/userComment/form?id=${userComment.id}">评价信息<shiro:hasPermission name="users:userComment:edit">${not empty userComment.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="users:userComment:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="userComment" action="${ctx}/users/userComment/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="users:userComment:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
