...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/station/station/">通信站列表</a></li>
		<li class="active"><a href="${ctx}/station/station/form?id=${station.id}">通信站<shiro:hasPermission name="station:station:edit">${not empty station.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="station:station:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="station" action="${ctx}/station/station/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="proviceId" htmlEscape="false" maxlength="11" class="input-xlarge  digits"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="area" name="area.id" value="${station.area.id}" labelName="area.name" labelValue="${station.area.name}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="recommend" htmlEscape="false" maxlength="4" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="station:station:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
