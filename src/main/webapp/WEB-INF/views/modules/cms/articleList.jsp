			...
			<tr>
				...
				<td>
					...
					<shiro:hasPermission name="cms:article:edit">
						...
						<a target="_blank" href="${ctxFront}/cms/article/preview?id=${article.id}">预览</a>
	    				<a href="${ctx}/cms/article/form?id=${article.id}">修改</a>
	    				 <shiro:hasPermission name="cms:article:audit">
							<a href="${ctxFront}/cms/article/delete?id=${article.id}&categoryId=${article.category.id}" onclick="return confirmx('确认要删除该文章吗？', this.href)" >删除</a>
						</shiro:hasPermission>
					</shiro:hasPermission>
				</td>
			</tr>
