...
<body>
	...
	<form id="listForm" method="post">
		<table id="treeTable" class="table table-striped table-bordered table-condensed">
			<tr>
				<th>栏目名称</th>
				<th>归属机构</th><!-- <th>栏目模型</th> -->
				<th style="text-align:center;">排序</th>
				<th title="是否在首页导航中显示该栏目">是否首页显示</th>
				...
				<tr id="${tpl.id}" pId="${tpl.parent.id ne '1'?tpl.parent.id:'0'}">
					...
					<td>
						...
						<shiro:hasPermission name="cms:category:edit">
							...
							<a href="${ctx}/cms/category/delete?id=${tpl.id}" onclick="return confirmx('要删除该栏目及该栏目下的所有文章吗？', this.href)">删除</a>
