...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/testh/testH/">测试功能列表</a></li>
		<shiro:hasPermission name="testh:testH:edit"><li><a href="${ctx}/testh/testH/form">测试功能添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="testH">
			<tr>
				...
				<shiro:hasPermission name="testh:testH:edit"><td>
    				...
    				<shiro:hasPermission name="testh:testH:del">
					<a href="${ctx}/testh/testH/delete?id=${testH.id}" onclick="return confirmx('确认要删除该测试功能吗？', this.href)">删除</a>
					</shiro:hasPermission>
