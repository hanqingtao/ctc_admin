...
<link rel="stylesheet" type="text/css" href="${ctxStatic}/css/page.css" />
...
<script type="text/javascript" src="${ctxStatic}/jquery-validation/1.11.1/jquery.validate.min.js" ></script>
